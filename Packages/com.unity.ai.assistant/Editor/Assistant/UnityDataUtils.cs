...
namespace Unity.AI.Assistant.Editor
{
    static class UnityDataUtils
    {
        ...
        {
            var projectId = string.IsNullOrEmpty(CloudProjectSettings.projectId) ? PlayerSettings.productGUID.ToString() : CloudProjectSettings.projectId; 
            return $"{AssistantConstants.ProjectIdTagPrefix}{projectId.Replace("-", "")}";
        }
